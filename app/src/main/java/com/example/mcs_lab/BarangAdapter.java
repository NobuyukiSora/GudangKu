...
//    }
    ...
    public barangViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_rv_list_barang,parent,false);
    ...
    public void onBindViewHolder(@NonNull barangViewholder holder, int position) {
        ...
        holder.id.setText(brg.get(position).getIdbarang());
    ...
    class barangViewholder extends RecyclerView.ViewHolder{
        ...
        public barangViewholder(@NonNull View itemView){
            ...
            id = itemView.findViewById(R.id.idbarang);
